...
class WipeOutContactHistoryPiiActionTest {
  ...
  void getAllHistoryEntries_returnOneEntryInList() {
    ...
    ImmutableList<ContactHistory> nonEmptyResultList = action.getAllHistoryEntriesOlderThan(month);
    assertThat(nonEmptyResultList.size()).isEqualTo(1);
    assertThat(nonEmptyResultList.contains(contactHistory)).isTrue();
    ImmutableList<ContactHistory> emptyResultList = action.getAllHistoryEntriesOlderThan(month + 2);
  ...
  void getAllHistoryEntries_returnsNonEmptyList() {
    ...
    ImmutableList<ContactHistory> resultList = action.getAllHistoryEntriesOlderThan(month);
