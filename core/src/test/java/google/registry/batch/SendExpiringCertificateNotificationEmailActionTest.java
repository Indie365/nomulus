...
class SendExpiringCertificateNotificationEmailActionTest {
  ...
  void run_sentZeroEmail_responseStatusIs200() {
    ...
    assertThat(response.getPayload())
        .isEqualTo("Done. Attempted to send 0 expiring certificate notification emails in total.");
  }
  ...
  void run_sentEmails_responseStatusIs200() throws Exception {
    ...
    assertThat(response.getStatus()).isEqualTo(SC_OK);
    assertThat(response.getPayload())
        .isEqualTo("Done. Attempted to send 5 expiring certificate notification emails in total.");
  }
