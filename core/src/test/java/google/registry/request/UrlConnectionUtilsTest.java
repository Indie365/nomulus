...
import static google.registry.request.UrlConnectionUtils.writePayloadMultipart;
  ...
  void testSetPayloadMultipart_boundaryInPayload() {
    ...
    IllegalStateException thrown =
        assertThrows(
            ...
            () -> writePayloadMultipart(connection, "lol", "cat", CSV_UTF_8, payload, random));
    assertThat(thrown)
        .hasMessageThat()
        .contains(
