...
public class PremiumListDatastoreDaoTest {
  ...
  void testSave_largeNumberOfEntries_succeeds() {
    ...
    PremiumList list = PremiumListDatastoreDao.getLatestRevisionUncached("tld").get();
    assertThat(PremiumListDatastoreDao.getPremiumPrice(list, "7", "tld"))
  ...
  @Test
  void testExists() {
    assertThat(PremiumListDatastoreDao.getLatestRevisionUncached("tld")).isPresent();
    assertThat(PremiumListDatastoreDao.getLatestRevisionUncached("nonExistentPremiumList"))
        .isEmpty();
  }

  @Test
  void testGetPremiumPrice_comesFromBloomFilter() throws Exception {
    PremiumList pl = PremiumListDatastoreDao.getLatestRevisionUncached("tld").get();
    ...
    assertThat(PremiumListDatastoreDao.getPremiumPrice(pl, "missingno", "tld")).isEmpty();
  ...
  void testGetPremiumPrice_cachedSecondTime() {
    assertThat(PremiumListDatastoreDao.getPremiumPrice(pl, "rich", "tld"))
  ...
  void testGetPremiumPrice_bloomFilterFalsePositive() {
    ...
    assertThat(PremiumListDatastoreDao.getPremiumPrice(pl, "rich", "tld")).isEmpty();
    assertThat(PremiumListDatastoreDao.getPremiumPrice(pl, "rich", "tld")).isEmpty();
  ...
  void testSave_removedPremiumListEntries_areNoLongerInDatastore() {
    ...
    assertThat(PremiumListDatastoreDao.getPremiumPrice(pl, "genius", "tld"))
        .hasValue(Money.parse("USD 10"));
    assertThat(PremiumListDatastoreDao.getPremiumPrice(pl, "dolt", "tld"))
    ...
    pl = PremiumListDatastoreDao.getLatestRevisionUncached("tld").get();
    assertThat(PremiumListDatastoreDao.getPremiumPrice(pl, "genius", "tld"))
        .hasValue(Money.parse("USD 10"));
    assertThat(PremiumListDatastoreDao.getPremiumPrice(pl, "savant", "tld"))
        .hasValue(Money.parse("USD 90"));
    assertThat(PremiumListDatastoreDao.getPremiumPrice(pl, "dolt", "tld")).isEmpty();
  ...
  void testGetPremiumPrice_allLabelsAreNonPremium_whenNotInList() {
    PremiumList pl = PremiumListDatastoreDao.getLatestRevisionUncached("tld").get();
    assertThat(PremiumListDatastoreDao.getPremiumPrice(pl, "blah", "tld")).isEmpty();
    assertThat(PremiumListDatastoreDao.getPremiumPrice(pl, "slinge", "tld")).isEmpty();
  ...
  void testSave_simple() {
    ...
    persistResource(Registry.get("tld").asBuilder().setPremiumList(pl).build());
    assertThat(PremiumListDatastoreDao.getPremiumPrice(pl, "lol", "tld"))
        .hasValue(Money.parse("USD 999"));
    assertThat(PremiumListDatastoreDao.getPremiumPrice(pl, "lol ", "tld")).isEmpty();
  ...
  void test_saveAndUpdateEntriesTwice() {
    PremiumList pl = PremiumListDatastoreDao.save("pl", ImmutableList.of("test,USD 1"));
    ImmutableMap<String, PremiumListEntry> entries = loadPremiumListEntries(pl);
    ...
    PremiumList resaved = PremiumListDatastoreDao.save("pl", ImmutableList.of("test,USD 1"));
    ofy().clearSessionCache();
    PremiumListDualDao.premiumListCache.invalidateAll();
    Map<String, PremiumListEntry> entriesReloaded =
        loadPremiumListEntries(PremiumListDatastoreDao.getLatestRevisionUncached("pl").get());
  ...
  void testDelete() {
    ...
    Optional<PremiumList> gtld1 = PremiumListDatastoreDao.getLatestRevisionUncached("gtld1");
    ...
    assertThat(PremiumListDatastoreDao.getLatestRevisionUncached("gtld1")).isEmpty();
  ...
  void testDelete_largeNumberOfEntries_succeeds() {
    ...
    assertThat(PremiumListDatastoreDao.getLatestRevisionUncached("ginormous")).isEmpty();
  }
