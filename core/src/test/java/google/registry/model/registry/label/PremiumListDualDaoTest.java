...
public class PremiumListDualDaoTest {
  ...
  @TestOfyOnly
  void testGetPremiumPrice_secondaryLoadFailureSql() {
    PremiumListSqlDao.delete(PremiumListSqlDao.getLatestRevisionUncached("tld").get());
    assertThat(
            assertThrows(
        ...
        .hasCauseThat()
        .hasMessageThat()
        .isEqualTo("Premium list tld is present in Datastore but not SQL.");
  }

  @TestSqlOnly
  void testGetPremiumPrice_secondaryLoadFailureOfy() {
    PremiumList premiumList = PremiumListDatastoreDao.getLatestRevisionUncached("tld").get();
    ...
    assertThat(
        ...
        .hasCauseThat()
        .hasMessageThat()
        .isEqualTo("Premium list tld is present in SQL but not Datastore.");
  }
  ...
  void test_savePremiumList_clearsCache() {
    ...
    transactIfJpaTm(() -> PremiumListDualDao.save("tld", ImmutableList.of("test,USD 1")));
    assertThat(PremiumListDualDao.premiumListCache.getIfPresent("tld")).isNull();
  }
