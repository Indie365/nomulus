...
public final class OteStatsTestHelper {
  ...
  public static void setupCompleteOte(String baseClientId) throws IOException {
    ...
    persistResource(
        new DomainHistory.Builder()
            .setResource(persistActiveDomain("xn--abc-873b2e7eb1k8a4lpjvv.tld"))
    ...
    persistResource(
        new DomainHistory.Builder()
            .setResource(persistActiveDomain("example.tld"))
            .setRegistrarId(oteAccount1)
    ...
    persistResource(
        new HostHistory.Builder()
            .setResource(persistDeletedHost("ns1.example.tld", now))
            .setRegistrarId(oteAccount1)
  ...
  public static void setupIncompleteOte(String baseClientId) throws IOException {
    ...
    persistResource(
        new DomainHistory.Builder()
            .setResource(persistActiveDomain("exampleone.tld"))
            .setRegistrarId(oteAccount1)
            .setType(Type.DOMAIN_CREATE)
    ...
    persistResource(
        new DomainHistory.Builder()
            .setResource(persistActiveDomain("example-one.tld"))
            .setRegistrarId(oteAccount1)
            .setType(Type.DOMAIN_CREATE)
    ...
    persistResource(
        new DomainHistory.Builder()
            .setResource(persistDeletedDomain("example.tld", now))
            .setRegistrarId(oteAccount1)
    ...
    persistResource(
        new HostHistory.Builder()
            .setResource(persistActiveHost("example.tld"))
            .setRegistrarId(oteAccount1)
