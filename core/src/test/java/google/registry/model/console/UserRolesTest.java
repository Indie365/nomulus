...
public class UserRolesTest {
  ...
  void testAdmin_overridesAll() {
    ...
    assertThat(userRoles.hasGlobalPermission(ConsolePermission.MANAGE_USERS)).isTrue();
  ...
  void testRegistrarPermission_withGlobal() {
    ...
    assertThat(userRoles.hasGlobalPermission(ConsolePermission.MANAGE_USERS)).isTrue();
    assertThat(userRoles.hasPermission("someRegistrar", ConsolePermission.MANAGE_USERS)).isTrue();
  }
