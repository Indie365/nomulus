...
class DomainUpdateFlowTest extends ResourceFlowTestCase<DomainUpdateFlow, Domain> {
  ...
  @Test
  void testAnyPublishProhibitedStatusAddedTriggersDnsPubTask() throws Exception {
    setEppInput(
  ...
  @Test
  void testEveryPublishProhibitedStatusRemovalTriggersDnsPubTask() throws Exception {
    setEppInput(
        "domain_update_status_change.xml",
  ...
  @Test
  void testSomePublishProhibitedStatusChangeOrNoChangeTriggersNoDnsPubTask() throws Exception {
    setEppInput(
        "domain_update_status_change.xml",
