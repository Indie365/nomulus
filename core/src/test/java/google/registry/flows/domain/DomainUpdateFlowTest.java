...
class DomainUpdateFlowTest extends ResourceFlowTestCase<DomainUpdateFlow, Domain> {
  ...
  @Test
  void testDnsTaskTriggeredByChangeInStatusAffectingDns() throws Exception {
    setEppInput("domain_update_status_change.xml", ImmutableMap.of("STATUS", "clientHold"));
    persistReferencedEntities();
    persistResource(
        persistDomain()
            .asBuilder()
  ...
  @Test
  void testDnsTaskNotTriggeredByChangeInStatusNotAffectingDns() throws Exception {
    setEppInput(
        "domain_update_status_change.xml", ImmutableMap.of("STATUS", "clientUpdateProhibited"));
    persistReferencedEntities();
    persistResource(
        persistDomain()
            .asBuilder()
