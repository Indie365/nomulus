...
class ExportDomainListsActionTest extends MapreduceTestCase<ExportDomainListsAction> {
  ...
  private GcsUtils gcsUtils = new GcsUtils(LocalStorageHelper.getOptions().getService());
  ...
  void test_outputsOnlyDomainsOnRealTlds() throws Exception {
    ...
    assertThrows(FileNotFoundException.class, () -> gcsUtils.readBytesFrom(nonexistentFile));
