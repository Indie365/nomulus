 ...
 * {@link google.registry.persistence.transaction.JpaTransactionManagerExtension} with default
 * {@link org.junit.jupiter.api.Order}. The transaction manager extension needs to run first so that
 * when this override is called it's not trying to use the default dummy one.
 *
