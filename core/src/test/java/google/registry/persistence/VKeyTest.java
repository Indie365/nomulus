...
class VKeyTest {
  ...
  /** Test stringify() and create() with sqlKeys only {@link VKey}. */
  @Test
  ...
  /** Test stringify() and create() with ofyKeys only {@link VKey}. */
  @Test
  ...
  /** Test stringify() and create() with {@link VKey} that contain both sqlKey and ofyKey. */
  @Test
