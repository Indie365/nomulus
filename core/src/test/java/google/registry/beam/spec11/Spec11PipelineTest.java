...
class Spec11PipelineTest {
  ...
  void beforeEach() throws IOException {
    ...
    spec11Pipeline =
        new Spec11Pipeline(
            ...
            retrier);
    spec11Pipeline.useLocalCredentialForTesting(beamJpaExtension.getCredentialFile().getAbsolutePath());
    createTld("tld");
  }
  ...
  public void testSpec11ThreatMatchToSql() throws Exception {
    ...
    assertAboutImmutableObjects()
        .that(
            jpaTm()
                .transact(() -> Iterables.getOnlyElement(jpaTm().loadAll(Spec11ThreatMatch.class))))
