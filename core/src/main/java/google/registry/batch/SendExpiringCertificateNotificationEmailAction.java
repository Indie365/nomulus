...
public class SendExpiringCertificateNotificationEmailAction implements Runnable {
  ...
  public void run() {
    ...
    try {
      ...
      logger.atWarning().withCause(e).log(
          "Illegal arguments being passed in when sending expiring certificate notification "
              + "emails.");
      ...
      logger.atSevere().withCause(e).log(
          "Unexpected error when sending expiring certificate notification emails.");
   ...
   */
  @VisibleForTesting
  String getEmailBody(String registrarName, @Nonnull CertificateType type, Date expirationDate) {
