...
public class BatchModule {
  ...
  @Provides
  @Parameter(ResaveAllEppResourcesPipelineAction.PARAM_IS_FAST)
  static Optional<Boolean> provideIsFast(HttpServletRequest req) {
    return extractOptionalBooleanParameter(req, ResaveAllEppResourcesPipelineAction.PARAM_IS_FAST);
  }
