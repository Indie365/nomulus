...
public class ResaveAllEppResourcesPipelineAction implements Runnable {
  ...
  public static final String PARAM_IS_FAST = "isFast";

  private final String projectId;
  private final String jobRegion;
  private final String stagingBucketUrl;
  private final Optional<Boolean> isFast;
  ...
  ResaveAllEppResourcesPipelineAction(
      ...
      @Parameter(PARAM_IS_FAST) Optional<Boolean> isFast,
      Clock clock,
      Response response,
      Dataflow dataflow) {
          ...
          new LaunchFlexTemplateParameter()
              ...
              .setParameters(
                  new ImmutableMap.Builder<String, String>()
                      .put(PARAM_IS_FAST, isFast.orElse(Boolean.FALSE).toString())
