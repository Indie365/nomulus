...
public abstract class BaseFlowCustomLogic {
   ...
   *
   * <p>Note that it is possible for the EPP flow state to be absent, which happens when the custom logic is
   * running outside the context of an EPP flow (e.g. {@link DomainPricingCustomLogic} in backend actions).
   */
