...
public class AllocationTokenFlowUtils {
  ...
  public static Domain adjustDomainBasedOnAllocationToken(
    ...
    // Synchronize changed RecurringBillingEvent with storage,
    // prevents entities conflicts while in the transaction
    tm().transact(() -> tm().put(newRecurringBillingEvent));
