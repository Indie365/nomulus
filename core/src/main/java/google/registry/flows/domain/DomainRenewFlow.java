...
import static google.registry.flows.domain.token.AllocationTokenFlowUtils.applyToken;
...
public final class DomainRenewFlow implements TransactionalFlow {
  ...
  public EppResponse run() throws EppException {
    ...
    // If static token is applicable this should update the domain
    existingDomain = applyToken(existingDomain, allocationToken);
    ...
    if (allocationToken.isPresent()
        && AllocationToken.TokenBehavior.DEFAULT.equals(allocationToken.get().getTokenBehavior())
  ...
  private void verifyRenewAllowed(
    ...
    verifyTokenAllowedOnDomain(existingDomain, command, allocationToken);
