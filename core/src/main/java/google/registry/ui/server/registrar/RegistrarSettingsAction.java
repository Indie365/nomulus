...
public class RegistrarSettingsAction implements Runnable, JsonActionRunner.JsonAction {
   ...
   * testing.
   */
  private static ThreadLocal<Boolean> IS_IN_TEST_DRIVER = ThreadLocal.withInitial(() -> false);
  ...
  public static void setIsInTestDriverToFalse() {
    IS_IN_TEST_DRIVER.set(false);
  }

  public static void setIsInTestDriverToTrue() {
    IS_IN_TEST_DRIVER.set(true);
  }
  ...
  private void sendExternalUpdatesIfNecessary(
    ...
    if (IS_IN_TEST_DRIVER.get() == false) {
