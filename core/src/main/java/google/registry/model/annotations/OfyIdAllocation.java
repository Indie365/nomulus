 ...
 *
 * <p>This annotation is only used for fields of a {@link google.registry.model.Buildable} class
 * that were previously annotated by both Ofy's and JPA's {@code Id} annotations, of which the Ofy
 * annotation has been removed. The field still needs to be allocated automatically by the builder,
 * by the {@link IdService#allocateId()}.
 *
