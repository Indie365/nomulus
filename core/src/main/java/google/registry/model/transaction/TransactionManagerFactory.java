...
import google.registry.persistence.dao.ClaimsListDao;
...
public class TransactionManagerFactory {
  ...
  /** Returns {@link ClaimsListDao} instance. */
  public static ClaimsListDao claimsListDao() {
    return component.claimsListDao();
  }
}
