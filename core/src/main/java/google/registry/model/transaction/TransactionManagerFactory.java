...
public class TransactionManagerFactory {
  ...
  private static JpaTransactionManager createJpaTransactionManager() {
    ...
    } else if (shouldEnableJpaTmForTool()) {
  ...
  private static boolean shouldEnableJpaTmForTool() {
    return RegistryToolEnvironment.isInRegistryTool()
        && RegistryToolEnvironment.get().shouldEnableJpaTm();
  }
