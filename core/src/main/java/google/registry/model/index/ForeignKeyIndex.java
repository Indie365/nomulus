...
import static google.registry.persistence.transaction.TransactionManagerFactory.readOnlyJpaTm;
...
public abstract class ForeignKeyIndex<E extends EppResource> extends BackupGroupRoot {
  ...
  private static <E extends EppResource>
    ...
    if (tm().isOfy()) {
      ...
      JpaTransactionManager jpaTmToUse = useReadOnlyJpaTm ? readOnlyJpaTm() : jpaTm();
