...
public class AllocationToken extends BackupGroupRoot implements Buildable {
  ...
  /**
   * DEFAULT tokens have standard behavior for Package promo tokens, they follow the same
   * verification and rules REMOVE_PACKAGE is a special kind of tokens that behaves like a signal to
   * the system to trigger domain removal from promotional package
   */
