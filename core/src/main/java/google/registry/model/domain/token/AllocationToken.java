...
public class AllocationToken extends BackupGroupRoot implements Buildable, DatastoreAndSqlEntity {
  ...
  public enum RenewalPriceBehavior {
     ...
     *
     * <p>This indicates the domain will be renewed at standard price even if it's a premium domain.
     * We chose to name this "NONPREMIUM" rather than simply "STANDARD" to avoid confusion between
