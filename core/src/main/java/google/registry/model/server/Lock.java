...
public class Lock extends ImmutableObject implements Serializable {
  ...
  public static Optional<Lock> acquire(
    ...
    JpaTransactionManager transactionManager = jpaTm();
    ...
    AcquireResult acquireResult = transactionManager.transactWithoutBackup(lockAcquirer);
  ...
  public void release() {
    ...
    transactionManager.transactWithoutBackup(lockReleaser);
  }
