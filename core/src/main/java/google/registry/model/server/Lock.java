...
public class Lock extends ImmutableObject implements DatastoreAndSqlEntity, Serializable {
  ...
  private static String makeLockId(String resourceName, String tld) {
  ...
  public static Optional<Lock> acquire(
    ...
    String namespace = tld != null ? tld : GLOBAL;
    String lockId = makeLockId(resourceName, namespace);
                ...
                () -> {
                  ...
                  Lock lock =
                      tm().loadByKeyIfPresent(
                              VKey.create(
                                  Lock.class,
                                  new LockId(resourceName, namespace),
    ...
    lockMetrics.recordAcquire(resourceName, namespace, acquireResult.lockState());
