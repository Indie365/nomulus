...
public final class IdService {
  ...
  /**
   * A SQL Sequence based ID supplier that allocates an ID from a monotonically increasing atomic
   * {@link long}
   *
   * <p>The generated IDs are project-wide unique
   */
  private static final Supplier<Long> SequenceBasedIdSupplier =
      () ->
          jpaTm()
              .transact(
                  () ->
  ...
  /**
   * A Datastore based ID supplier that allocates an ID from a monotonically increasing atomic
   * {@link long}
   *
   * <p>The generated IDs are project-wide unique
   */
  private static final Supplier<Long> DatastoreIdSupplier =
      () ->
  ...
  public static long allocateId() {
    Supplier<Long> idSupplier = DatastoreIdSupplier;
    if (DatabaseMigrationStateSchedule.getValueAtTime(DateTime.now(UTC))
      ...
      idSupplier = SequenceBasedIdSupplier;
    }
