    ...
    return tm().transactNew(
            () -> {
              ...
              Optional<PremiumList> existing =
                  tm().loadByKeyIfPresent(VKey.createOfy(PremiumList.class, key));
              checkState(
                  Objects.equals(existing, oldPremiumList), "PremiumList was concurrently edited");
              PremiumList newList =
                  premiumList
                      .asBuilder()
