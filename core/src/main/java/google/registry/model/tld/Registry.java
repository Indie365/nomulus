...
public class Registry extends ImmutableObject implements Buildable, UnsafeSerializable {
  ...
  private static final long serialVersionUID = -7292862698396930853L;
  ...
  public static class TldStateTransition extends TimedTransition<TldState> {
    ...
    private static final long serialVersionUID = -600391612357241222L;
  ...
  public static class BillingCostTransition extends TimedTransition<Money> {
    ...
    private static final long serialVersionUID = 3262824573818177817L;
  ...
  public VKey<Registry> createVKey() {
    return VKey.createSql(Registry.class, tldStrId);
  }
   ...
   *
   * <p>This will be equal to {@link #tldStrId} for ASCII TLDs, but will be non-ASCII for IDN TLDs.
  ...
  public InternetDomainName getTld() {
    return InternetDomainName.from(tldStrId);
  }
  ...
  public static class Builder extends Buildable.Builder<Registry> {
    ...
    public Registry build() {
      ...
      String tldName = instance.tldStrId;
  ...
  public static class RegistryNotFoundException extends RuntimeException {
    ...
    private static final long serialVersionUID = -8643244156418374054L;
