...
public final class ForeignKeyUtils {
   ...
   *
   * <p>Because the foreign keys in question are coming from external commands, and therefore don't
   * necessarily represent entities in our system that actually exist, the returned cached map may
   * omit certain keys for which the entity does not exist. Several layers up the EPP command will
   * fail with an error message like "The contact with given IDs (blah) don't exist."
   *
