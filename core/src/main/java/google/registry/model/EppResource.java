...
import static google.registry.persistence.transaction.TransactionManagerFactory.readOnlyTm;
  ...
  static final CacheLoader<VKey<? extends EppResource>, EppResource> CACHE_LOADER =
      new CacheLoader<VKey<? extends EppResource>, EppResource>() {
        ...
        public EppResource load(VKey<? extends EppResource> key) {
          return readOnlyTm().doTransactionless(() -> readOnlyTm().loadByKey(key));
        }

        @Override
        public Map<VKey<? extends EppResource>, EppResource> loadAll(
            Iterable<? extends VKey<? extends EppResource>> keys) {
          return readOnlyTm().doTransactionless(() -> readOnlyTm().loadByKeys(keys));
        }
      };
