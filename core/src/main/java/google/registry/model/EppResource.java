...
public abstract class EppResource extends BackupGroupRoot implements Buildable {
  ...
  protected void saveIndexesToDatastore() {
    ofyTm().putIgnoringReadOnlyWithoutBackup(ForeignKeyIndex.create(this, getDeletionTime()));
    ofyTm().putIgnoringReadOnlyWithoutBackup(EppResourceIndex.create(Key.create(this)));
  }
