...
public class UserRoles extends ImmutableObject implements Buildable {
  ...
  /** The global role (e.g. support agent) that the user has across all registrars. */
  ...
  /**
   * The global role (e.g. {@link GlobalRole#SUPPORT_AGENT} that the user has across all registrars.
   */
