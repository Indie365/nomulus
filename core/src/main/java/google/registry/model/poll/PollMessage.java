 ...
 * their creation (not modification). The revision ids are used directly by the Java code, but their
 * presence in the database makes it easier to diagnose potential issues related to poll messages.
 *
...
public abstract class PollMessage extends ImmutableObject
  ...
  public enum Type {
    ...
    /**
     * Returns the type specified by the identifer, {@link Optional#empty} if the id is out of
     * range.
     */
  ...
  public static class Autorenew extends PollMessage {
    ...
    /** The auto-renew recurs annually between {@link #eventTime} and this time. */
