...
public class HistoryEntry extends ImmutableObject implements Buildable, DatastoreEntity {
  ...
  /**
   * Returns the representation of the EppResource at this point in time.
   *
   * <p>Subclasses should override this to return the resource; it is non-abstract for legacy
   * reasons and objects created prior to the Registry 3.0 migration.
   */
