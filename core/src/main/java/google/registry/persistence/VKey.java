...
public class VKey<T> extends ImmutableObject implements Serializable {
   ...
   * }</pre>
   *
   * <p>The final key id or name is obtained from the SQL key. It is assumed that this value must
   * be either a long integer or a {@code String} and that this proper identifier for the objectify
   * key.
   *
