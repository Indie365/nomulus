...
/** Object Classes defined in RFC9083 section 5. */
final class RdapObjectClasses {
  ...
  /**
   * The Entity Object Class defined in 5.1 of RFC9083.
   *
  ...
  /**
   * Registrar version of the Entity Object Class defined in 5.1 of RFC9083.
   *
   * <p>Entities are used both for Contacts and for Registrars. We will create different subobjects
   * for each one for type safety.
   */
  ...
  /**
   * Contact version of the Entity Object Class defined in 5.1 of RFC9083.
   *
   * <p>Entities are used both for Contacts and for Registrars. We will create different subobjects
   * for each one for type safety.
   */
  ...
  /** The Nameserver Object Class defined in 5.2 of RFC9083. */
  ...
  /** Object defined in RFC9083 section 5.3, only used for RdapDomain. */
  ...
  abstract static class SecureDns extends AbstractJsonableObject {
     ...
     *
     * <p>Note that although it isn't given as optional in RFC9083, in RFC5910 it's mentioned as
  ...
  /**
   * The Domain Object Class defined in 5.3 of RFC9083.
   *
  ...
  /** Error Response Body defined in 6 of RFC9083. */
  @RestrictJsonNames({})
  @AutoValue
  ...
  /**
   * Help Response defined in 7 of RFC9083.
   *
