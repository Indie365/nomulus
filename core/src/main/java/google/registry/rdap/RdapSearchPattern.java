...
public final class RdapSearchPattern {
   ...
   *
   * <p>Based on RFC9082 4.1. Must contains only alphanumeric plus dots and hyphens. A single
   ...
   * charecters. If such an asterix exists - it must be at the end of a domain label.
   *
   * <p>In theory, according to RFC9082 4.1 - we should make some checks about partial matching in
