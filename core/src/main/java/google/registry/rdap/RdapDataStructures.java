...
/** Data Structures defined in RFC9083 section 4. */
final class RdapDataStructures {

  private RdapDataStructures() {}

  /** RDAP conformance defined in 4.1 of RFC9083. */
  ...
  /** Links defined in 4.2 of RFC9083. */
  ...
  /**
   * Notices and Remarks defined in 4.3 of RFC9083.
   *
  ...
  /**
   * Notices defined in 4.3 of RFC9083.
   *
  ...
  abstract static class Notice extends NoticeOrRemark {
    ...
    /**
     * Notice and Remark Type are defined in 10.2.1 of RFC9083.
     *
  ...
  /**
   * Remarks defined in 4.3 of RFC9083.
   *
  ...
  /**
   * Language Identifier defined in 4.4 of RFC9083.
   *
  ...
  /**
   * Events defined in 4.5 of RFC9083.
   *
  ...
  /**
   * Status defined in 4.6 of RFC9083.
   *
  ...
  /**
   * Port 43 WHOIS Server defined in 4.7 of RFC9083.
   *
  ...
  /**
   * Public IDs defined in 4.8 of RFC9083.
   *
  ...
  /**
   * Object Class Name defined in 4.7 of RFC9083.
   *
  ...
  enum ObjectClassName implements Jsonable {
    /** Defined in 5.1 of RFC9083. */
    ENTITY("entity"),
    /** Defined in 5.2 of RFC9083. */
    NAMESERVER("nameserver"),
    /** Defined in 5.3 of RFC9083. */
    DOMAIN("domain"),
    /** Defined in 5.4 of RFC9083. Only relevant for Registrars, so isn't implemented here. */
    IP_NETWORK("ip network"),
    /** Defined in 5.5 of RFC9083. Only relevant for Registrars, so isn't implemented here. */
