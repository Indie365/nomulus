 ...
 *
 * <p>Note that the primary key of this entity is {@link #revisionId}, which
 * is auto-generated by the database. So, if a retry of insertion happens after
 * the previous attempt unexpectedly succeeds, we will end up with having two
 * exact same claims list with only different {@link #revisionId}. However, this
 * is not an actual problem because we only use the claims list with highest
 * {@link #revisionId}.
 */
@Entity
...
public class ClaimsList {
  ...
  private ClaimsList(DateTime creationTimestamp, Map<String, String> labelsToKeys) {
  ...
  public Long getRevisionId() {
    return checkNotNull(revisionId);
  }
