...
@Table(
    ...
    indexes = {
      ...
      @Index(
          name = "idx_registry_lock_unlock_verification_code",
          columnList = "unlockVerificationCode"),
...
public final class RegistryLock extends ImmutableObject implements Buildable {
  ...
  /** The user must provide the random verification code in order to complete the unlock. */
  ...
  public String getUnlockVerificationCode() {
    return unlockVerificationCode;
  }
  ...
  public static class Builder extends Buildable.Builder<RegistryLock> {
    ...
    public Builder setUnlockVerificationCode(String unlockVerificationCode) {
      getInstance().unlockVerificationCode = unlockVerificationCode;
      return this;
    }
