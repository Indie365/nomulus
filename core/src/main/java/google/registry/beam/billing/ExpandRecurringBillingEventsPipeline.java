...
public class ExpandRecurringBillingEventsPipeline implements Serializable {
  ...
  private PCollection<Void> expandRecurrings(
    ...
    return recurrings
        ...
        // distributing elements to random keys in this step might reduce overall throughput as
        // more elements need to be processed to generate a batch, when batching only occurs on
        // elements with the same key, delaying the subsequent steps when batches can be produced
        // as soon as possible.
        //
