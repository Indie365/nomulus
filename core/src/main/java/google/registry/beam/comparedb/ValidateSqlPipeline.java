...
import google.registry.beam.comparedb.DatastoreSnapshotInfoFinder.DatastoreSnapshotInfo;
...
public class ValidateSqlPipeline {
  ...
  public static void main(String[] args) {
    ...
    DatastoreSnapshotInfo mostRecentExport =
        DaggerDatastoreSnapshotInfoFinder_GcsFileFinderComponent.create()
