...
/** Finds information that helps loading a Datastore snapshot. */
public class DatastoreSnapshotInfoFinder {
  ...
  /**
   * Finds information that helps loading a Datastore snapshot, including the GCS folder of the most
   * recent Datastore export, its start and end times, and the folder of the CommitLog files.
   */
  ...
  /** Holds information that helps loading a Datastore snapshot. */
  @AutoValue
  abstract static class DatastoreSnapshotInfo {
    ...
    static DatastoreSnapshotInfo create(
      ...
      return new AutoValue_DatastoreSnapshotInfoFinder_DatastoreSnapshotInfo(
  ...
  interface GcsFileFinderComponent {

    DatastoreSnapshotInfoFinder datastoreSnapshotInfoFinder();
  }
}
