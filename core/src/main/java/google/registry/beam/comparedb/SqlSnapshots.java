 ...
 *
 * <p>For {@link DomainBase} and {@link DomainHistory}, this class uses the
 * BulkQueryJpaTransactionManager to achieve higher query throughput.
 */
public final class SqlSnapshots {
   ...
   *
   * <p>If {@code snapshotId} is present, all queries with use the specified database snapshot,
