...
import static google.registry.request.UrlConnectionUtils.writePayload;
    ...
    byte[] responseBytes =
        retrier.callWithRetry(
            () -> {
              ...
              connection.setRequestMethod(PUT.name());
              setBasicAuth(connection, username, password);
              writePayload(connection, reportBytes, MEDIA_TYPE.toString());
