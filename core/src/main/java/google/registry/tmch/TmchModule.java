...
public final class TmchModule {
  ...
  static URL provideNordnUrl(HttpServletRequest req) {
    try {
      return new URL(extractRequiredHeader(req, NordnVerifyAction.NORDN_URL_PARAM));
  ...
  @Provides
  @Parameter(NordnVerifyAction.NORDN_LOG_ID_ARAM)
  static String provideNordnLogId(HttpServletRequest req) {
    return extractRequiredParameter(req, NordnVerifyAction.NORDN_LOG_ID_ARAM);
  }
}
