 ...
 * contains, regardless of order. To verify that they are indeed the same one still need to verify
 * internal consistency within each deposit (i.e. to verify that all hosts and contacts referenced
 * by domains are included in the deposit) by calling {@code
