 ...
 * domains, regardless of the order. To verify that they are indeed the same one still need to
 * verify internal consistency within each deposit (i.e. to verify that all hosts and contacts
