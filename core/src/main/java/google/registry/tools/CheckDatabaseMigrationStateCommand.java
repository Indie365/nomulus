...
public class CheckDatabaseMigrationStateCommand implements CommandWithRemoteApi {

  @Override
  public void run() throws Exception {
    MigrationState migrationState = DatabaseMigrationStateWrapper.get();
    System.out.println(String.format("Current migration state: %s", migrationState));
  }
}
