...
public enum RegistryToolEnvironment {
  ...
  private static boolean shouldEnableJpaTm = false;
  ...
  public static void enableJpaTm() {
    shouldEnableJpaTm = true;
  }

  /** Returns true if the JpaTransactionManager should be enabled. */
  public static boolean shouldEnableJpaTm() {
    return shouldEnableJpaTm;
  }
