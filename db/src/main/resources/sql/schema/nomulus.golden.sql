...
--
-- Name: idx_registry_lock_unlock_verification_code; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_registry_lock_unlock_verification_code ON public."RegistryLock" USING btree (unlock_verification_code);
