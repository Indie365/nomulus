...
CREATE TABLE public."Domain" (
    ...
    lordn_phase text DEFAULT 'NONE'::text
);
...
CREATE INDEX idx7wg0yn3wdux3xsc4pfaljqf08 ON public."Host" USING btree (dns_refresh_request_time);
...
CREATE INDEX idxnjhib7v6fj7dhj5qydkefkl2u ON public."Domain" USING btree (lordn_phase);
