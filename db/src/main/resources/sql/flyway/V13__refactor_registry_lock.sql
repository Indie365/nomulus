...
ALTER TABLE "RegistryLock" ADD COLUMN unlock_verification_code text;

CREATE INDEX idx_registry_lock_unlock_verification_code on "RegistryLock" (unlock_verification_code);
